---
title: "Competidores"
tags: [competidores, landscape]
updated: 2026-04-07
---

# Competidores — Tabla Comparativa

## Voice AI Platforms (competidores directos)
...
| **[Air AI](air-ai.md)** | $70M+ | -- | Consumer AI calls | Primer "continuous AI" | Controversial — FTC lawsuit | Sin presencia | No |
| **[Vapi](vapi.md)** | $25.2M (Serie A) | SF, CA | Developer platform voice AI | API-first, open-source friendly | ~4.5/5 (G2) | Sin presencia | No |
| **[Voiceflow](voiceflow.md)** | $38.5M | Toronto | No-code conversation design | Canvas visual, equipo + agencia ecosystem | 4.6/5 (G2) | Sin presencia | No |

## Enterprise AI Agent Platforms (horizontal)

| Company | Funding | Valoración | HQ | Foco | España | Amenaza |
|---------|---------|-----------|-----|------|--------|---------|
| **[Sierra AI](sierra-ai.md)** | $635M | ~$10B | SF, CA | Customer experience AI | **Oficina en Madrid** | **ALTA** — misma ciudad, enterprise |
| **[Parloa](parloa.md)** | $350M (Serie D) | ~$3B | Berlin | Contact center AI enterprise | **Abriendo Madrid 2026** | **ALTA** — enterprise EU, compliance |
| **[PolyAI](poly-ai.md)** | $200M+ | -- | London | Voice assistants enterprise | Sin oficina España | Media — London = cerca |

!!! warning "Competidores en Madrid"
    Sierra AI ya tiene oficina en Madrid y Parloa planea abrir en 2026. Estos son los competidores más directos para HappyRobot en el mercado español enterprise.
...
| **Compliance EU** | SOC2+GDPR+HIPAA+EU AI Act | Limitado | SOC2+GDPR+HIPAA | SOC2+GDPR | SOC2+GDPR+ISO27001 |
| **Pricing** | Enterprise custom | $0.09/min | $0.08/min | Enterprise custom | Enterprise custom |
| **Agentic reasoning** | Hybrid agentic+deterministic | Flow-based | Flow-based (no-code) | Agentic | Agentic |
| **España/Europa** | Madrid office | No | Berlin (sin España) | **Madrid office** | **Madrid planned** |
...
- **Bland AI, Retell AI, Vapi** — US-only, developer-focused, sin presencia EU
- **Air AI** — FTC lawsuit, producto cuestionable
- **Voiceflow** — No-code conversation design, más tool que competidor directo

## Diferenciación de HappyRobot
...
*Fuentes: Research subagentes abril 2026. Ver cada nodo de competidor para fuentes detalladas.*
