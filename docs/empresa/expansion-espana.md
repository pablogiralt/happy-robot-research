...
type: empresa
status: completo
tags: [empresa, españa, expansion, gtm]
updated: 2026-04-07
---

# HappyRobot — Expansión a España

## ¿Por qué España?

| Razón | Detalle | Conf | Fuente |
|-------|---------|------|--------|
| **Fundadores españoles** | [Pablo](../personas/pablo-palafox.md) y [Javier Palafox](../personas/javier-palafox.md) son de Guadalajara (Castilla-La Mancha). >50% del equipo es español | A | [UPST-HR] [NA-HR] |
| **Oficina en Madrid** | Ya operativa en Chamberí. Hiring activo para SF + Madrid | B | [LUMA-HACK] [ASH-HR] |
...
## Oficina Madrid — Estado actual

| Dato | Valor | Conf | Fuente |
|------|-------|------|--------|
| **Ubicación** | Chamberí, Madrid | B | [LUMA-HACK] |
| **Actividades confirmadas** | Hackathon AI Agents (dic 2025) co-organizado con Kibo Ventures y Cursor | B | [LUMA-HACK] |
| **Empleados Madrid** | En crecimiento — team distributed SF + Madrid | B | [ASH-HR] |
| **Relación local** | [Aquilino Peña](../personas/aquilino-pena.md) (Kibo Ventures) co-organizó evento en la oficina | B | [LUMA-HACK] |

## Posiciones abiertas en España

| Rol | Tipo | Salario estimado (España) | Equivalente SF |
|-----|------|--------------------------|----------------|
| Enterprise Account Executive (Spain) | Sales | EUR 75-77K base + EUR 135-147K OTE | $250-400K OTE |
| Forward Deployed Engineer (Europe) | Engineering | EUR 60-110K | $200-400K |
| GTM Operations | Operations | EUR 80-130K | $120-200K |
...
!!! warning "Sierra AI y Parloa ya están aquí"
    No estamos solos en Madrid:
...
1. **53% de empresas logísticas tienen estrategia AI** pero **84% carecen de formación** [A: CEL-AI, WEBPICK-AI] — Quieren AI pero necesitan soluciones gestionadas
2. **E-waybills obligatorios desde sept 2026** [A: GETTRANS-EWBN] — Fuerza digitalización del sector
3. **30,000 vacantes de conductores**, edad media 50+ años [A: CDC-DRIV] — Urgencia de automatización en scheduling/dispatching
4. **Solo 7% de empresas logísticas tienen cultura digital avanzada** [B: GOPLAN-DIG] — Enorme espacio para leapfrog con AI agents
...
|---------|------|---------|---------|
| SEUR Geopost | Express/paquetería | ~EUR 1,200M+ | Líder paquetería España |
| DHL Express Spain | Express | ~EUR 800M+ | **Ya cliente de HR a nivel global** |
| XPO Logistics Spain | 3PL | Top-10 global | Fuerte presencia España |
| Correos / Correos Express | Postal + express | EUR 748M | Operador público, 19.4% market share |
| GLS Spain | Express | Creciendo | Adquirió ASM + Redyser |
| Logista | Nacional | Major | Incluye Nacex |
...
| **AI Governance** | AI Auditor dedicado | Enterprise-grade | Enterprise-grade | No |
| **Fundadores españoles** | Pablo + Javier Palafox | No (Bret Taylor, US) | No (Malte Kosub, DE) | Sí (locales) |
| **Multi-canal** | Voz+email+chat+SMS+WhatsApp | Chat+voz | Voz+chat | Chat solo |

## Regulación como ventaja

España es un mercado donde la regulación **favorece** a HappyRobot:

1. **[EU AI Act](../regulacion/eu-ai-act.md)** — Art. 50 exige disclosure de AI en interacciones. HappyRobot ya lo implementa. Competidores US-only (Bland, Vapi, Retell) no.
2. **[GDPR/LOPDGDD](../regulacion/gdpr-lopdgdd.md)** — Voz = dato personal. HappyRobot ofrece data residency EU + configuración de retención por cliente.
3. **AEPD guía agéntica** — El regulador español publicó guía específica para AI agents. El AI Auditor de HappyRobot mapea directamente a las recomendaciones.
4. **Robinson List** — Outbound marketing calls requieren verificar lista Robinson. Importante para use cases de sales.
5. **ePrivacy** — Llamadas comerciales automáticas sin consentimiento son ilegales en España (Synthflow tiene este problema).

## Industria events & asociaciones clave

| Organización | Rol | Relevancia |
|-------------|------|-----------|
| **CEL** (Centro Español de Logística) | Principal asociación logística, publica estudios AI | Networking + thought leadership |
| **AECOC** | Asociación fabricantes + distribuidores | Supply chain focus, conferencias |
| **UNO Logística** | Asociación operadores logísticos | Acceso a operadores target |
| **SIL Barcelona** | Feria logística líder sur Europa | Demo + generación pipeline |
| **OTLE** | Observatorio gubernamental transporte | Datos + credibilidad institucional |

## Lo que Lola aporta al puesto

| Activo de Lola | Aplicación directa |
|----------------|-------------------|
...
| **ICADE + LBS + Columbia** | Credibilidad con C-level de grandes operadores |
